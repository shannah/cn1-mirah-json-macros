 ...
 */
package ca.weblite.oscon2014.schedulebuilder.util;
...
public class HTMLEntityDecoder {
    ...
    public static final String unescapeHtml3(final String input) {
        ...
        while (true) {
            ...
            if (input.charAt(i) == '#') {
                ...
                try {
                    ...
                    if ( buf == null ){
                        buf = new char[input.length()];
                    }
                    char[] substr = input.substring(st, i - 1).toCharArray();
                    for ( int idx=0; idx<substr.length; idx++){
                        buf[bufIdx++] = substr[idx];
                    }
                ...
                // named escape
                String value = lookupMap.get(input.substring(i, j));
                if (value == null) {
                    i++;
                    continue;
                }
        ...
        if (buf != null) {
            ...
            char[] substr = input.substring(st, len).toCharArray();
            for ( int idx=0; idx<substr.length; idx++){
                buf[bufIdx++] = substr[idx];
            }
